      ...
      <main className="relative z-10 mx-auto flex min-h-[calc(100dvh-90px)] w-full max-w-6xl items-center px-5 pb-16 md:px-8">
        <div className="grid w-full items-center gap-12 lg:grid-cols-[1.1fr_.9fr]">
          ...
          <div className="soft-card screen-enter rounded-3xl p-7 md:p-9">
            {!forgotMode ? (
              <form onSubmit={start}>
                <div className="mb-7 flex items-center justify-between"><div><div className="mono text-[10px] uppercase tracking-[.2em] text-[hsl(var(--muted-foreground))]">Create or sign in</div><h2 className="display mt-1 text-3xl font-bold leading-tight">Welcome, agent.</h2><p className="mt-1 text-sm font-medium text-[hsl(var(--muted-foreground))]">Your mission profile</p></div><div className="grid size-12 place-items-center rounded-2xl bg-[hsl(var(--foreground))] text-[hsl(var(--primary))]"><KeyRound size={20} /></div></div>
