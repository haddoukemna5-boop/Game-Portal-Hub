      ...
      <main className="relative z-10 mx-auto flex min-h-[calc(100dvh-90px)] w-full max-w-6xl items-center px-5 pb-16 md:px-8">
        <div className="grid w-full items-center gap-12 lg:grid-cols-[1.1fr_.9fr]">
          ...
          <div className="soft-card screen-enter rounded-3xl p-7 md:p-9">
            {!forgotMode ? (
              <form onSubmit={start}>
                <div className="mb-7 flex items-center justify-between"><div><div className="mono text-[10px] uppercase tracking-[.2em] text-[hsl(var(--muted-foreground))]">Create or sign in</div><h2 className="display mt-1 text-2xl font-bold">Your mission profile</h2><p className="mt-2 text-sm font-medium text-[hsl(var(--primary))]">Welcome, agent.</p></div><div className="grid size-12 place-items-center rounded-2xl bg-[hsl(var(--foreground))] text-[hsl(var(--primary))]"><KeyRound size={20} /></div></div>
